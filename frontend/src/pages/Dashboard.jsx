...
import { Plus, List, Map as MapIcon, X, Search, Filter } from 'lucide-react'
...
export default function Dashboard() {
    ...
    const { data, isLoading } = useIssues({ ...filters, page, limit: 12 })
        ...
        <div className="page-container">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-0.5">Report and track civic issues in your area</p>
                </div>
                <button
            ...
            {showForm && (
                <div className="card p-6 mb-8 animate-slide-up">
                    <h2 className="text-lg font-semibold text-gray-900 mb-5">Report a New Issue</h2>
                ...
                <>
                    {issues.length === 0 ? (
                        <div className="text-center py-20 text-gray-400">
                            ...
                            <p className="text-sm mt-1">Be the first to report a civic issue!</p>
                        </div>
                    ) : (
