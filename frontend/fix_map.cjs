const fs = require('fs');
let content = fs.readFileSync('src/pages/MapExplorer.jsx', 'utf8');
...
content = content.substring(0, startIdx) + returnStatement;

fs.writeFileSync('src/pages/MapExplorer.jsx', content);
